...
module Terms =
    ...
    module AssayMetadata = 
        ...
        let epectedNonObsoleteNonRootTerms = [
            ...
            CvTerm.create("ASSMSO:00000021", "Assay Person Last Name", "ASSMSO")
            CvTerm.create("ASSMSO:00000023", "Assay Person First Name", "ASSMSO")
            CvTerm.create("ASSMSO:00000025", "Assay Person Mid Initials", "ASSMSO")
            CvTerm.create("ASSMSO:00000027", "Assay Person Email", "ASSMSO")
            CvTerm.create("ASSMSO:00000029", "Assay Person Phone", "ASSMSO")
            CvTerm.create("ASSMSO:00000031", "Assay Person Fax", "ASSMSO")
            CvTerm.create("ASSMSO:00000033", "Assay Person Address", "ASSMSO")
            CvTerm.create("ASSMSO:00000035", "Assay Person Affiliation", "ASSMSO")
            CvTerm.create("ASSMSO:00000037", "Assay Person Roles", "ASSMSO")
            CvTerm.create("ASSMSO:00000039", "Assay Person Roles Term Accession Number", "ASSMSO")
            CvTerm.create("ASSMSO:00000041", "Assay Person Roles Term Source REF", "ASSMSO")
